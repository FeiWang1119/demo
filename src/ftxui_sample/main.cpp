...
// configuration step. It creates a namespace called `demo`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", demo::cmake::project_name, demo::cmake::project_version) };
